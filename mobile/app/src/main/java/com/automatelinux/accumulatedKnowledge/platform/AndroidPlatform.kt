...
import com.automatelinux.accumulatedKnowledge.data.KeyValueStore
import com.automatelinux.accumulatedKnowledge.data.PlatformActions
import com.automatelinux.accumulatedKnowledge.data.internationalDigits
...
class AndroidKeyValueStore(context: Context) : KeyValueStore {
    private val prefs = context.getSharedPreferences("accumulated_knowledge", Context.MODE_PRIVATE)
