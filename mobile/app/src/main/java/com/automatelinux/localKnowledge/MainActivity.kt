...
import com.automatelinux.localKnowledge.data.LocalKnowledgeApi
import com.automatelinux.localKnowledge.platform.AndroidActions
import com.automatelinux.localKnowledge.platform.AndroidKeyValueStore
import com.automatelinux.localKnowledge.platform.AndroidLocationProvider
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val api = LocalKnowledgeApi(BuildConfig.API_BASE_URL, BuildConfig.API_TOKEN)
